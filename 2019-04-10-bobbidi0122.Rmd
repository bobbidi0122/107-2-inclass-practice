...
```{r}
birthday[1:12]
str_c("西元",str_sub(birthday[1:12],1,4),"年",str_sub(birthday[1:12],5,6),"月",str_sub(birthday[1:12],7,8),"日")
```
```{r}
民國年月<-c("099/01","099/02","099/03")
month<-str_sub(民國年月,2,3)
date<-str_sub(民國年月,5,6)
c<-(as.integer(month))+1911
as.character(c)
str_c("西元",c,"年",date,"月")
```
